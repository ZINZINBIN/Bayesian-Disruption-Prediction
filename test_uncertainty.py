...
if __name__ == "__main__":
    ...
    fig.tight_layout()
    plt.title("Disruptive phase - Missing alarm case, shot : {}".format(test_shot))
    ...
    fig.tight_layout()
    plt.title("Normal phase - False alarm case, shot : {}".format(test_shot))
    ...
    fig.tight_layout()
    plt.title("Disruptive phase - True Positive case, shot : {}".format(test_shot))
