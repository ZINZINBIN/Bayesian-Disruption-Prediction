...
def complex_matmul(a : torch.Tensor, b : torch.Tensor, groups : int = 1):
...
def to_ntuple(val: Union[int, Iterable[int]], n: int):
...
def fft_conv(signal : torch.Tensor, kernel : torch.Tensor, bias : Optional[torch.Tensor] = None, padding : Union[int, Iterable[int]] = 0, padding_mode : str = "constant", stride : Union[int, Iterable[int]] = 1, dilation : Union[int, Iterable[int]]= 1, groups : int = 1):
